...
export default {
    ...
    mounted() {
        ...
        axios.get(`http://192.168.120.180:8081/employee/getEmployee/${this.$route.params.id}`, {
            headers: {
        ...
        this.$refs.invalidRole.addEventListener('blur', this.validateRole);
        this.$refs.invalidDepartment.addEventListener('blur', this.validateDepament);
    ...
    methods: {
        validateName() {
            ...
            axios.put(`http://192.168.120.180:8081/employee/update-employee/${this.$route.params.id}`, this.employee, {
                headers: {
                    'Authorization': 'Bearer ' + sessionStorage.getItem('token')
                }
            })
